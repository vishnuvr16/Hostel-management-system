...
<body>
    ...
    // SQL query to fetch data for active requests
    $sql = "SELECT * FROM requests WHERE status='pending' AND id='$id'";
    $result = $conn->query($sql);

    if ($result->num_rows > 0) {
        echo "<h1>Active Requests for ID: $id</h1><br>";
        echo "<table>";
        echo "<tr><th>ID</th><th>Reason</th><th>Description</th><th>No of Days</th><th>From Date</th><th>To Date</th><th>Destination</th><th>Student Contact</th><th>Parent Contact</th><th>Request Time</th><th>Status</th></tr>";
        ...
        echo "No active requests found for ID: $id";
    }
