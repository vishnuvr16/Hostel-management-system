...
<html lang="en">
                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto md-2 mb-lg-0">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="changeDetails.php">Change Details</a>
                      </li>
                      <li class="nav-item">
    ...
    $database = "id21288882_outpass";
            ...
            if ($result->num_rows > 0) {
                echo "<h1>OutPass History for ID: $id</h1><br>";
                echo "<table border='1 px'>";
                echo "<tr><th>ID</th><th>Reason</th><th>Description</th><th>No of Days</th><th>From Date</th><th>To Date</th><th>Destination</th><th>Student Contact</th><th>Parent Contact</th><th>Request Time</th><th>Status</th><th></tr>";
