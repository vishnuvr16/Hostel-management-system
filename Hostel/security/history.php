...
<html lang="en">
    ...
    $database = "id21288882_outpass";
            ...
            $sql = "SELECT * FROM requests where status='checkedin' and  checkin is NOT NULL and checkout is NOT NULL";
            $result = $conn->query($sql);
        
            if ($result->num_rows > 0) {
                echo "<h1>OutPass History</h1><br>";
                echo "<table border='1 px'>";
                echo "<tr><th>ID</th><th>No of Days</th><th>From Date</th><th>To Date</th><th>Destination</th><th>Student Contact</th><th>Parent Contact</th><th>Status</th><th>Check In</th><th>Check Out</th></tr>";
