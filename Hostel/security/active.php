...
<html lang="en">
                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="remaining.php">Remaining</a>
                      </li>
                      <li class="nav-item">
    ...
    $database = "id21288882_outpass";
            ...
            $sql = "SELECT * FROM requests where status='Approved' and checkin is NULL and checkout is NULL";
            $result = $conn->query($sql);
        
            if ($result->num_rows > 0) {
                echo "<h1>OutPass Requests</h1><br>";
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a href='checkout.php?request_id=$id'><button class='btn btn-danger'>Check Out</button></a></td>";
                    echo "</tr>";
                }
