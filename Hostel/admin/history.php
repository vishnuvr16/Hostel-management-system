    ...
    <div class="container">
        ...
        $sql = "SELECT * FROM requests where status!='pending'";
            ...
            if ($result->num_rows > 0) {
                echo "<h2 style='background-color: cadetblue;color:white;padding:10px;text-align:center'>OutPass History</h2>";
                echo "<div class='history_table' style='overflow-x:auto'>";
                echo "<table border='1 px'>";
                echo "<tr><th>ID</th><th>Reason</th><th>Description</th><th>No of Days</th><th>From Date</th><th>To Date</th><th>Destination</th><th>Student Contact</th><th>Parent Contact</th><th>Request Time</th><th>Status</th><th><th></tr>";
