...
<body>
    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            echo "<br><h2 class='head'>Students Details</h2>";
            echo "<form class='search-form' action='search.php' method='post'>
                    <div class='form-group'>
                        <input class='form-control' name='search' type='search' placeholder='Search' aria-label='Search' autocomplete='off' required>
            ...
            echo "<table>";
            echo "<tr><th>ID</th><th>Name</th><th>Email</th><th>Batch</th><th>Branch</th><th>Mobile</th><th colspan='2' style='text-align:center'>Action</th></tr>";
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='remove_student.php?id=$id'><button class='btn btn-danger'>Remove</button></a></td>";
                echo "</tr>";
            }
