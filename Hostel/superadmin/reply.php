...
<html lang="en">
    <head>
        ...
        <body style="background-color:cadetblue">
            ...
            <div class="body">
            <form action="messageAction.php?sender=$sender" method="post">
                <input type="text" name="subject" class="input-style" placeholder="Subject" required>
                <hr>
                <textarea class="input-style" name="body" placeholder="Reply to message" required></textarea>
                <hr>
                <button class="button" type="submit">Reply to <?php echo $sender ?></i></button>
            </form>
            </div>
